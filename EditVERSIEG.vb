...
Public Class EditVERSIEG
    ...
    Private Function Savedata() As Boolean
        ...
        Dim updaterec = (From versieg In db.VERSIEGs
                         Where versieg.VERSIEGNRQ = keyversiegnrq).ToList()(0)

        updaterec.VERSIEG = TBversieg.Text
        Try
            db.SubmitChanges()
    ...
    Private Sub SaveNEW()
        Dim newrec As New VERSIEG With {
              .VERSIEG = TBversieg.Text}

        db.VERSIEGs.InsertOnSubmit(newrec)
        Try
            db.SubmitChanges()
        Catch ex As Exception
            PositionMsgbox.CenterMsgBox(Me)
            ...
            ' Handle exception.  
        End Try
        keyversiegnrq = newrec.versiegnrq
    End Sub
