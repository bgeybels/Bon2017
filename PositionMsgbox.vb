...
Public Class PositionMsgbox
    ...
    Private Shared Function EnumWindow(ByVal hWnd As IntPtr, ByVal lp As IntPtr) As Boolean
        ...
        mPos = New Point(mRect.Left + (mRect.Width - (rc.Right - rc.Left)) \ 2,
    ...
    Private Declare Auto Function SetWindowPos Lib "user32.dll" (ByVal hWnd As IntPtr, ByVal hAfter As IntPtr,
