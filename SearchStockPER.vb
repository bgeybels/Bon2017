...
Public Class SearchStockPER
    ...
    Private Sub SearchStockPER_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub FillInfo()
        ...
        TBinfo1.BackColor = System.Drawing.SystemColors.ControlLight
        TBinfo2.BackColor = System.Drawing.SystemColors.ControlLight

        TBinfo1.Text = ""
        TBinfo2.Text = ""

        fndarr = GetPerInfo(keypernrq).split("#")
        TBinfo1.Text = fndarr(0)
        TBinfo2.Text = fndarr(1)
    End Sub
