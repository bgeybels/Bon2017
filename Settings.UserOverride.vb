...
Namespace My
    Partial Friend NotInheritable Class MySettings
        ...
        Private Shared userOverrides() As String = {
            "BONConnectionString"
        }

        Private Shared userOverrideSuffix As String = "UserOverride"

        Public Sub SetUserOverride(ByVal [property] As String,
                                   ByVal value As String)
            Me([property]) = value
        End Sub

        Private Sub userOverride_SettingsLoaded(ByVal sender As Object,
        ...
        Private Sub userOverride_SettingsSaving(ByVal sender As Object,
